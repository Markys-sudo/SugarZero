...
async def gpt(update, context):
    dialog.mode ='services'
    await send_photo(update, context,'services')
    msg = load_message('services')
    await send_text(update, context, msg)
...
app.add_handler(CommandHandler('services', gpt))
